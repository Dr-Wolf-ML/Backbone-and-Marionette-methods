...
function () {
  function View(parent, model) {
    ...
    this.regionsMap = function () {
      return {};
    }; // changed from abstract to a basic implementation
...
function () {
  function Model(attributes, sync, events) {
    ...
    this.sync = sync;
    this.events = events; // Caution:  brittle code:
...
function () {
  function Attributes(data) {
    ...
    this.data = data; // get a specific key of the data object
...
function (_super) {
  ...
  function User() {
    ...
    _this.setRandomAge = function () {
      var age = Math.round(Math.random() * 100 + 1);
